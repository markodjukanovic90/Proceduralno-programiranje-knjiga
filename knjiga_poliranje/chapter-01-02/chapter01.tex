...
\subsection{Neke često korištene ugrađene funkcije}
...
Modul \texttt{sys} omogućava pristup informacijama i funkcijama vezanim za Pajtonov interpreter i izvršno okruženje. Neki od najčešće korištenih funkcija i atributa ovog modula su dati u nastavku.
...
Modul \texttt{getopt} služi za parsiranje opcija i argumenata komandne linije. Njegova funkcionalnost slična je istoimenoj funkciji dostupnoj u Unix operativnim sistemima. Najvažnija funkcija modula je:
