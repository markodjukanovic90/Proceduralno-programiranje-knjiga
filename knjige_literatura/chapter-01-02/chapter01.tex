...
\item \textit{Poboljšane performanse izvršavanja}.  PVM koristi bajtkod  interpreter, koji je brži od direktnog interpretera izvornog k\^oda. PVM može da koristi \textit{Just-In-Time} (JIT) kompilaciju za dalje poboljšanje performansi.
...
\begin{enumerate}
	...
	\item Napisati regularni izraz koji prepoznaje imejlove. Testirati primjenu tog paterna uz pomoć modula \texttt{re}.
	...
	invarijantna vrijednost što se postiže konstrukcijom odgovarajućeg regularnog izraza koji parsira  sadržaj svakog reda iz datoteke.
   ...
   Markovic, $20.2.2022, 8,4$ isti kao Marko Markovic, $20.\ \ 2.2022, 8,\ \ 4$, itd.  Dakle, prazan karakter je
   invarijantna vrijednost što se postiže konstrukcijom odgovarajućeg regularnog izraza koji parsiraju  sadržaj svakog reda iz datoteke.
\end{enumerate}