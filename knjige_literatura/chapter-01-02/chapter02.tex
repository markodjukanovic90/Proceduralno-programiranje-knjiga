...
Postoji nekoliko načina da se formalno provjeri valjanost algoritama. Izdvajau se tri osnovna načina:
...
\begin{example}
	...
	odakle slijedi da je NZD$(400, 24)=8$. Za razliku od naivnog algoritma za nalazak NZD iz prethodnog poglavlja, koji bi za ovu instancu izveo 17 iteracija do nalaska rješenja, vidimo da za Euklidov algoritam treba svega 3 iteracije da nađe tačno rješenje. 
...
Kako smo vidjeli, iako je Euklidov algoritam predstavljen relativno jednostavnim k\^odom, njegovu složenost nije trivijalno odrediti. Napomenimo da Euklidov algoritam predstavlja jedan vid rekurzivnog algoritma.  %, gdje rekurzija u tijelu funkcije poziva samu sebe, ali sa ulazom manje veličine. 
