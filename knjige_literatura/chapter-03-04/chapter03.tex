...
\begin{solution}
 	...
 	\begin{figure}[H]
 	 ...
 	 \caption{Problem hanojskih kula, $n=3$ diska.\protect\footnotemark}     \label{fig:tower}
 	 	\end{figure}
\footnotetext{Slika sa linka \url{https://www.geeksforgeeks.org/c-program-for-tower-of-hanoi/}}
...
\end{figure}
\footnotetext{Slika sa linka \url{https://www.geeksforgeeks.org/n-queen-problem-backtracking-3/}}
