...
Fundamentalna teorema aritmetike kaže da se svaki broj $n \in \mathbb{N}$ može na jedinstven način faktorisati na proizvod prostih činilaca, do na redoslijed faktora. Dakle, svaki $n$ se može zapisati u formi
 ...
 Npr. broj 120 se može faktorisati kao $2^3 \cdot 3^1 \cdot 5^1$. Sa stanovišta izračunavanja, postavlja se pitanje na koji način efikasno izvršiti problem izračunavanja faktorizacije broja.  U tu svrhu, iskoristićemo znanje o Eratostenovom situ. 
